    ...
    <div className='bg-dark'>
      ...
      <div className="row ">
        <div className="col-6 col-md-2 mb-3">
          ...
          <ul className="nav flex-column">
            <li className="nav-item mb-2 text-white "><a href="#" className="nav-link p-0 text-white">Home</a></li>
            <li className="nav-item mb-2 text-white"><a href="#" className="nav-link p-0 text-white">Features</a></li>
      ...
      <div className="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
        ...
        <ul className="list-unstyled d-flex ">
          <i className="fa-brands fa-twitter text-white " style={{ width: '35px',fontSize:'30px' }}></i>
          <i className="fa-brands fa-instagram text-white" style={{ width: '35px',fontSize:'30px' }}></i>
          <i className="fa-brands fa-facebook text-white" style={{ width: '35px',fontSize:'30px' }}></i>
